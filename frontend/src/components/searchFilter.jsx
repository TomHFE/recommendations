...
export function SearchFilter () {
    ...
    return (
        ...
        <p>Cost-friendly - please rate the level of cost. Where 1 is for very cost friendly and 5 is expensive</p>
        <input 
        type = "text"
        value = {costFriendly}
        ...
        <input type="checkbox" value = {vegeterian} onChange={handleVegeterian}/>
        ...
        <input type="checkbox" value = {pescatarian} onChange={handlePescatarian}/>
        <label htmlFor="checkbox">Pescatarian</label>
        
        <input type="checkbox" value = {glutenFree} onChange={handleGlutenFree}/>
